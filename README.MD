...
> A robust, lightweight Python utility designed to streamline the extraction of Base64-encoded SHA-256 fingerprints for SSL/TLS Certificates and Subject Public Key Info (SPKI).
